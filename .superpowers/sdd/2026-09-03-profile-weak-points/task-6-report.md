...
## `npm run test:profile-weak-points` after review fix

```text
> test:profile-weak-points
> node --experimental-strip-types lib/profile-weak-points.test.ts

(node:76244) [MODULE_TYPELESS_PACKAGE_JSON] Warning: Module type of file:///C:/Users/%E6%B5%B7%E9%98%94%E5%A4%A9%E7%A9%BA/Desktop/Echo%20Offer/frontend/lib/profile-weak-points.test.ts is not specified and it doesn't parse as CommonJS.
Reparsing as ES module because module syntax was detected. This incurs a performance overhead.
To eliminate this warning, add "type": "module" to C:\Users\海阔天空\Desktop\Echo Offer\frontend/package.json.
(Use `node --trace-warnings ...` to show where the warning was created)
profile weak points contract tests passed
...
## `npm run build` after review fix
