...
INTERVIEWER_SYSTEM_PROMPT = (
    ...
    "像真实面试一样说话，不要直接说出‘业务目标’、‘个人职责’、‘团队边界’、‘核验’、‘评分’这类内部标签；"
    "例如把‘业务目标’问成‘当时为什么要做这个项目’，把‘个人职责’问成‘你主要负责哪一块’，"
    "把‘团队边界’问成‘团队里其他人主要负责什么’。"
...
def build_planner_prompt(context: dict) -> tuple[str, str]:
    ...
    system = (
        ...
        "每个节点只负责一个目标，必须给出可执行的 opening_question。"
        "opening_question 是面试官要直接说给候选人的话，要像真实面试一样说话；"
        "不要直接说出‘业务目标’、‘个人职责’、‘团队边界’、‘required_targets’等内部标签，"
        "要改成‘当时为什么做这个项目’、‘你主要负责哪一块’、‘团队里其他人负责什么’这类自然问法。"
        "只返回 JSON。"
    )
    user_payload = {
