      ...
      <div className="mint-shell">
        ...
        <section className="mint-hero" aria-label="面试准备介绍">
          <div>
            ...
            <h1 className="mint-title">把你做过的项目，<br /><em>讲清楚。</em></h1>
          ...
          <aside className="mint-hero-card" aria-label="本次准备内容">
            ...
            <p className="mint-hero-card-copy">从一份简历开始，挑一个你真正做过的项目，练习如何把它讲完整。</p>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <section className="mint-section" aria-labelledby="analysis-heading">
            <div className="mint-section-heading">
              <div className="mint-section-heading-main"><span className="mint-section-index">03</span><div><p className="mint-section-eyebrow">从简历里挑一个</p><h2 id="analysis-heading" className="mint-section-title">整理项目</h2></div></div>
            </div>
            <div className="mint-card mint-upload-card">
            ...
            {!resumeId && <p className="mint-note">上传 PDF 或 DOCX 后可以自动整理，也可以直接手动填写项目内容。</p>}
          </section>

          {analysisResult && (
            <section className="mint-section" aria-labelledby="analysis-result-heading">
              <div className="mint-section-heading"><div className="mint-section-heading-main"><span className="mint-section-index">04</span><div><p className="mint-section-eyebrow">看一眼，再确认</p><h2 id="analysis-result-heading" className="mint-section-title">整理出的项目</h2></div></div></div>
          ...
          <section className="mint-section" aria-labelledby="project-heading">
            <div className="mint-section-heading"><div className="mint-section-heading-main"><span className="mint-section-index">05</span><div><p className="mint-section-eyebrow">最后确认</p><h2 id="project-heading" className="mint-section-title">{homeCopy.projectSection}</h2></div></div></div>
            <div className="mint-card mint-edit-card">
